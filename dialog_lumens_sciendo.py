...
class DialogLumensSCIENDO(QtGui.QDialog, DialogLumensBase):
    ...
    def setupUi(self, parent):
        ...
        self.layoutTabCropSimulation = QtGui.QGridLayout()
        ...
        self.tabCropSimulation.setLayout(self.layoutTabCropSimulation)
        ...
        #***********************************************************
        # Setup 'Crop Simulation' tab
        #***********************************************************
        # 'Main Configuration' Tab Widget
        #***********************************************************
        # 'Working Directory' Group Box
                
        self.groupBoxCropSimulationWorkingDirectory = QtGui.QGroupBox('Working Directory')
        self.layoutGroupBoxCropSimulationWorkingDirectory = QtGui.QGridLayout()
        self.layoutGroupBoxCropSimulationWorkingDirectory.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.groupBoxCropSimulationWorkingDirectory.setLayout(self.layoutGroupBoxCropSimulationWorkingDirectory)
        
        self.labelCropSimulationWorkingDirectory = QtGui.QLabel()
        self.labelCropSimulationWorkingDirectory.setText('Select Working Directory : ')
        self.layoutGroupBoxCropSimulationWorkingDirectory.addWidget(self.labelCropSimulationWorkingDirectory, 0, 0)
        
        self.lineEditCropSimulationWorkingDirectory = QtGui.QLineEdit()
        self.lineEditCropSimulationWorkingDirectory.setReadOnly(True)
        self.layoutGroupBoxCropSimulationWorkingDirectory.addWidget(self.lineEditCropSimulationWorkingDirectory, 0, 1)
        
        self.buttonSelectCropSimulationWorkingDirectory = QtGui.QPushButton()
        self.buttonSelectCropSimulationWorkingDirectory.setText('&Browse')
        self.layoutGroupBoxCropSimulationWorkingDirectory.addWidget(self.buttonSelectCropSimulationWorkingDirectory, 0, 2)
        
        # 'Meteorology File Builder' Group Box 
        self.groupBoxCropSimulationMeteorologyFileBuilder = QtGui.QGroupBox('Meteorology File Builder')
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder = QtGui.QGridLayout()
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.groupBoxCropSimulationMeteorologyFileBuilder.setLayout(self.layoutGroupBoxCropSimulationMeteorologyFileBuilder)
        
        self.labelMeteorologyFileBuilderSelectInputData = QtGui.QLabel()
        self.labelMeteorologyFileBuilderSelectInputData.setText('Select Input Data : ')
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.labelMeteorologyFileBuilderSelectInputData, 0, 0)
        
        self.lineEditMeteorologyFileBuilderSelectInputData = QtGui.QLineEdit()
        self.lineEditMeteorologyFileBuilderSelectInputData.setReadOnly(True)
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.lineEditMeteorologyFileBuilderSelectInputData, 0, 1)
        
        self.buttonMeteorologyFileBuilderSelectInputData = QtGui.QPushButton()
        self.buttonMeteorologyFileBuilderSelectInputData.setText('&Browse')
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.buttonMeteorologyFileBuilderSelectInputData, 0, 2)
        
        self.labelMeteorologyFileBuilderAreaName = QtGui.QLabel()
        self.labelMeteorologyFileBuilderAreaName.setText('Area Name :')
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.labelMeteorologyFileBuilderAreaName, 1, 0)
        
        self.lineEditMeteorologyFileBuilderAreaName = QtGui.QLineEdit()
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.lineEditMeteorologyFileBuilderAreaName, 1, 1)
        
        self.buttonMeteorologyFileBuilderCreateMeteorologyFile = QtGui.QPushButton()
        self.buttonMeteorologyFileBuilderCreateMeteorologyFile.setText('&Create Meteorology File')
        self.layoutGroupBoxCropSimulationMeteorologyFileBuilder.addWidget(self.buttonMeteorologyFileBuilderCreateMeteorologyFile, 2, 2)
        
        # 'Parameters' Group Box
        self.groupBoxCropSimulationParameters = QtGui.QGroupBox('Meteorology File Builder')
        self.layoutGroupBoxCropSimulationParameters = QtGui.QGridLayout()
        self.layoutGroupBoxCropSimulationParameters.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.groupBoxCropSimulationParameters.setLayout(self.layoutGroupBoxCropSimulationParameters)
        self.groupBoxCropSimulationParametersCropOptions = QtGui.QGroupBox('Crop Options')
        self.layoutGroupBoxCropSimulationParametersCropOptions = QtGui.QGridLayout()
        self.layoutGroupBoxCropSimulationParametersCropOptions.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.groupBoxCropSimulationParametersCropOptions.setLayout(self.layoutGroupBoxCropSimulationParametersCropOptions)
        self.layoutGroupCropSimulationParametersInput = QtGui.QGridLayout()
        self.layoutGroupCropSimulationParametersInput.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.layoutGroupBoxCropSimulationParameters.addWidget(self.groupBoxCropSimulationParametersCropOptions, 0, 0)
        self.layoutGroupBoxCropSimulationParameters.addLayout(self.layoutGroupCropSimulationParametersInput, 0, 1)
        
        self.checkBoxCropSimulationParametersPotato = QtGui.QCheckBox('Potato')
        self.checkBoxCropSimulationParametersRice = QtGui.QCheckBox('Rice')
        self.checkBoxCropSimulationParametersWheat = QtGui.QCheckBox('Wheat')
        self.checkBoxCropSimulationParametersSugar = QtGui.QCheckBox('Sugar')
        
        self.layoutGroupBoxCropSimulationParametersCropOptions.addWidget(self.checkBoxCropSimulationParametersPotato, 0, 0)
        self.layoutGroupBoxCropSimulationParametersCropOptions.addWidget(self.checkBoxCropSimulationParametersRice, 0, 1)
        self.layoutGroupBoxCropSimulationParametersCropOptions.addWidget(self.checkBoxCropSimulationParametersWheat, 1, 0)
        self.layoutGroupBoxCropSimulationParametersCropOptions.addWidget(self.checkBoxCropSimulationParametersSugar, 1, 1)
        
        self.labelCropSimulationParametersInitialDate = QtGui.QLabel()
        self.labelCropSimulationParametersInitialDate.setText('Simulation Initial Date : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersInitialDate, 0, 0)
        
        self.dateEditCropSimulationParametersInitialDate = QtGui.QDateEdit()
        self.layoutGroupCropSimulationParametersInput.addWidget(self.dateEditCropSimulationParametersInitialDate, 0, 1)
        
        self.labelCropSimulationParametersFinalDate = QtGui.QLabel()
        self.labelCropSimulationParametersFinalDate.setText('Simulation Final Date : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersFinalDate, 1, 0)
        
        self.dateEditCropSimulationParametersFinalDate = QtGui.QDateEdit()
        self.layoutGroupCropSimulationParametersInput.addWidget(self.dateEditCropSimulationParametersFinalDate, 1, 1)
        
        self.labelCropSimulationParametersSelectMeteorologyFile = QtGui.QLabel()
        self.labelCropSimulationParametersSelectMeteorologyFile.setText('Select Meteorology File : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersSelectMeteorologyFile, 2, 0)
        
        self.lineEditCropSimulationParametersSelectMeteorologyFile = QtGui.QLineEdit()
        self.lineEditCropSimulationParametersSelectMeteorologyFile.setReadOnly(True)
        self.layoutGroupCropSimulationParametersInput.addWidget(self.lineEditCropSimulationParametersSelectMeteorologyFile, 2, 1)
        
        self.buttonCropSimulationParametersSelectMeteorologyFile = QtGui.QPushButton()
        self.buttonCropSimulationParametersSelectMeteorologyFile.setText('&Browse')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.buttonCropSimulationParametersSelectMeteorologyFile, 2, 2)
        
        self.labelCropSimulationParametersLandCoverMap = QtGui.QLabel()
        self.labelCropSimulationParametersLandCoverMap.setText('Land Cover Map : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersLandCoverMap, 3, 0)
        
        self.comboBoxCropSimulationParametersLandCoverMap = QtGui.QComboBox()
        self.layoutGroupCropSimulationParametersInput.addWidget(self.comboBoxCropSimulationParametersLandCoverMap, 3, 1)
        
        self.labelCropSimulationParametersSoilMap = QtGui.QLabel()
        self.labelCropSimulationParametersSoilMap.setText('Soil Map : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersSoilMap, 4, 0)
        
        self.lineEditCropSimulationParametersSoilMap = QtGui.QLineEdit()
        self.lineEditCropSimulationParametersSoilMap.setReadOnly(True)
        self.layoutGroupCropSimulationParametersInput.addWidget(self.lineEditCropSimulationParametersSoilMap, 4, 1)
        
        self.buttonCropSimulationParametersSoilMap = QtGui.QPushButton()
        self.buttonCropSimulationParametersSoilMap.setText('&Browse')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.buttonCropSimulationParametersSoilMap, 4, 2)
        
        self.labelCropSimulationParametersElevationMap = QtGui.QLabel()
        self.labelCropSimulationParametersElevationMap.setText('Elevation Map : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersElevationMap, 5, 0)
        
        self.lineEditCropSimulationParametersElevationMap = QtGui.QLineEdit()
        self.lineEditCropSimulationParametersElevationMap.setReadOnly(True)
        self.layoutGroupCropSimulationParametersInput.addWidget(self.lineEditCropSimulationParametersElevationMap, 5, 1)
        
        self.buttonCropSimulationParametersElevationMap = QtGui.QPushButton()
        self.buttonCropSimulationParametersElevationMap.setText('&Browse')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.buttonCropSimulationParametersElevationMap, 5, 2)
        
        self.labelCropSimulationParametersSlopeMap = QtGui.QLabel()
        self.labelCropSimulationParametersSlopeMap.setText('Slope Map : ')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.labelCropSimulationParametersSlopeMap, 6, 0)
        
        self.lineEditCropSimulationParametersSlopeMap = QtGui.QLineEdit()
        self.lineEditCropSimulationParametersSlopeMap.setReadOnly(True)
        self.layoutGroupCropSimulationParametersInput.addWidget(self.lineEditCropSimulationParametersSlopeMap, 6, 1)
        
        self.buttonCropSimulationParametersSlopeMap = QtGui.QPushButton()
        self.buttonCropSimulationParametersSlopeMap.setText('&Browse')
        self.layoutGroupCropSimulationParametersInput.addWidget(self.buttonCropSimulationParametersSlopeMap, 6, 2)
        
        # 'Management Tools' Group Box        
        self.groupBoxCropSimulationManagementTools = QtGui.QGroupBox('Management Tools')
        self.groupBoxCropSimulationManagementTools.setGeometry(0, 0, 240, 180)
        self.layoutGroupBoxCropSimulationManagementTools = QtGui.QVBoxLayout()
        self.layoutGroupBoxCropSimulationManagementTools.setAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.groupBoxCropSimulationManagementTools.setLayout(self.layoutGroupBoxCropSimulationManagementTools)
        
        self.buttonCropSimulationManagementToolsSaveSimulation = QtGui.QPushButton()
        self.buttonCropSimulationManagementToolsSaveSimulation.setText('Save Simulation')
        self.layoutGroupBoxCropSimulationManagementTools.addWidget(self.buttonCropSimulationManagementToolsSaveSimulation)
        
        self.buttonCropSimulationManagementToolsSaveSimulationAs = QtGui.QPushButton()
        self.buttonCropSimulationManagementToolsSaveSimulationAs.setText('Save Simulation As')
        self.layoutGroupBoxCropSimulationManagementTools.addWidget(self.buttonCropSimulationManagementToolsSaveSimulationAs)
        
        self.buttonCropSimulationManagementToolsLoadSimulation = QtGui.QPushButton()
        self.buttonCropSimulationManagementToolsLoadSimulation.setText('Load Simulation')
        self.layoutGroupBoxCropSimulationManagementTools.addWidget(self.buttonCropSimulationManagementToolsLoadSimulation)
        
        self.buttonCropSimulationManagementToolsManagementOptions = QtGui.QPushButton()
        self.buttonCropSimulationManagementToolsManagementOptions.setText('Management Options')
        self.layoutGroupBoxCropSimulationManagementTools.addWidget(self.buttonCropSimulationManagementToolsManagementOptions)
        
        self.buttonCropSimulationManagementToolsEditVariable = QtGui.QPushButton()
        self.buttonCropSimulationManagementToolsEditVariable.setText('Edit Variables')
        self.layoutGroupBoxCropSimulationManagementTools.addWidget(self.buttonCropSimulationManagementToolsEditVariable)
        
        # Place the Group Box
        #self.groupWorkingDirectoryMeteorologyFile = QtGui.QWidget()
        #self.layoutGroupWorkingDirectoryMeteorologyFile = QtGui.QVBoxLayout()
        #self.groupWorkingDirectoryMeteorologyFile.setLayout(self.layoutGroupWorkingDirectoryMeteorologyFile)
        self.layoutTabCropSimulation.addWidget(self.groupBoxCropSimulationWorkingDirectory, 0, 0, 1, 2)
        self.layoutTabCropSimulation.addWidget(self.groupBoxCropSimulationMeteorologyFileBuilder, 1, 0)
        self.layoutTabCropSimulation.addWidget(self.groupBoxCropSimulationParameters, 2, 0, 2, 2)
        #self.layoutTabLowEmissionDevelopmentAnalysis.addWidget(self.groupBoxDriversAnalysis, 2, 0)
        #self.layoutTabLowEmissionDevelopmentAnalysis.addWidget(self.groupBoxBuildScenario, 3, 0)
        #self.layoutTabCropSimulation.addLayout(self.layoutButtonLowEmissionDevelopmentAnalysis, 4, 0, 1, 2, QtCore.Qt.AlignRight)
        self.layoutTabCropSimulation.addWidget(self.groupBoxCropSimulationManagementTools, 1, 1)
        #self.layoutTabCropSimulation.addWidget(self.groupBoxCropSimulationCropOptions, 2, 1)
        #self.layoutTabCropSimulation.setColumnStretch(0, 3)
        #self.layoutTabCropSimulation.setColumnStretch(1, 1) # Smaller template column
